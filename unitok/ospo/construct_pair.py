...
def _filter_chosen(chosen_cand, threshold=0.3):
...
if __name__ == "__main__":
    ...
    init_path = "/nas2/data/Janus_dataset/next_v2/unitok/dataset/prompt/init_dataset_15359.json"
    vqa_path = "/nas2/data/Janus_dataset/next_v2/unitok/dataset/prompt/vqa_result_base_v2_v1.json" # seed 012 (ONLY)
    save_path = "/nas2/data/Janus_dataset/next_v2/unitok/dataset/train"
    ...
    for sample in tqdm(vqa_data, "Processing samples ..."):
        ...
        if selected_metadata is not None and item_id in init_dict:
            dsample = init_dict[item_id]
