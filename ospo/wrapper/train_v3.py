...
class JanusProTrainWrapper(pl.LightningModule):
    ...
    def get_batch_logps(
        ...
        if token_masks is not None:
            ...
            # debug 5
            # print("token mask")
            # print(tm.shape) # torch.Size([16, 576])

            # img_start, img_end = img_span
            ...
            mask_full = mask_full.clamp_(0.0, 1.0)
