...
_VQA_QS_PROMPT_LAYOUT = Template("""
...
A pancake on the left of a pasta.
Concepts and relations: a pancake, a pasta, a pancake is on the left of a pasta; Questions: Is there a pancake? Is there a pasta? Is a pancake on the left of a pasta?

A lamp behind a screwdriver.
Concepts and relations: a lamp, a screwdriver, a lamp is behind a screwdriver; Questions: Is there a lamp? Is there a screwdriver? Is a lamp behind a screwdriver?

Three light bulbs and eight pumpkins.
Concepts and relations: three light bulbs, eight pumpkins; Questions: Are there three light bulbs? Are there eight pumpkins?
...
class VLMEvaluatorAsync:
    ...
    def format_prompt(sample: Dict[str, Any]) -> str:
        return _VQA_QS_PROMPT_LAYOUT.substitute(
...
def parse_args():
    ...
    parser.add_argument("--save_name", type=str, default="layout.json")
...
async def async_main(args):
    ...
    for sample in data:
        ...
        prompts.append(_VQA_QS_PROMPT_LAYOUT.substitute(prompt=sample["prompt"]))
