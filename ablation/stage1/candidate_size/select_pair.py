...
if __name__ == "__main__":
    ...
    # save_dir = "/nas2/data/Janus_dataset/next_v2/train"
    

    for n in [5,6,9]:
        init_path = f"/nas2/data/Janus_dataset/next_v2/ablation/pair_size/pair_size_{n}.json" 
        vqa_path = f"/nas2/data/Janus_dataset/next_v2/ablation/pair_size/vqa_result_pair_size_{n}.json"
        save_dir = f"/nas2/data/Janus_dataset/next_v2/ablation/pair_size/train_size_{n}"
        ...
        for sample in tqdm(vqa_data, "Processing samples ..."):
            ...
            if selected_metadata is not None:
                dsample = init_dict.get(item_id, None)
                if dsample is None:
                    continue
