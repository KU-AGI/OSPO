...
_VQA_QS_PROMPT_ATTRIBUTE = Template("""
...
A white harp and a rust soup.
Concepts and relations: a white harp, a rust soup; Questions: Is there a white harp? Is there a rust soup?

A quarter circle lily and a hexagon mirror.
Concepts and relations: a quarter circle lily, a hexagon mirror; Questions: Is there a quarter-circle lily? Is there a hexagon mirror?

Shiny mop and metal key holder.
Concepts and relations: a shiny mop, a metal key holder; Questions: Is there a shiny mop? Is there a metal key holder?
...
class VLMEvaluatorAsync:
    ...
    def format_prompt(sample: Dict[str, Any]) -> str:
        return _VQA_QS_PROMPT_ATTRIBUTE.substitute(
...
def parse_args():
    ...
    parser.add_argument("--save_name", type=str, default="attribute.json")
...
async def async_main(args):
    ...
    for sample in data:
        ...
        prompts.append(_VQA_QS_PROMPT_ATTRIBUTE.substitute(prompt=sample["prompt"]))
    ...
    evaluator = VLMEvaluatorAsync(
        ...
        max_tokens=256, # args.max_tokens,
        n=1 # args.n,
    )
